      ...
      <div className="container-custom">
        ...
        >
          <motion.div 
            ...
            className="inline-block mb-8 p-4 bg-accent/30 rounded-2xl"
          >
            <FaGraduationCap className="text-5xl text-white/40" />
          </motion.div>
            ...
            {educations.map((education, index) => (
              ...
              >
                <div className="glass rounded-3xl p-8 h-full border border-accent/30 hover:border-accent/50 hover:bg-accent/5 transition-all duration-500 shadow-xl hover:shadow-2xl hover:-translate-y-3">
                  ...
                  {/* Institution */}
                  <div className="flex items-center gap-3 mb-6 p-3 bg-secondary-dark rounded-2xl">
